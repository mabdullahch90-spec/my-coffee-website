...
pages = {
    'index.html': 'index_ss.png',
    'coffee-selection.html': 'coffee_selection_ss.png',
    'brewing-equipment.html': 'brewing_equipment_ss.png',
    'shopping-cart.html': 'shopping_cart_ss.png',
    'events-workshops.html': 'events_workshops_ss.png',
    'offers-subscriptions.html': 'offers_subscriptions_ss.png'
}

for html_file, img_name in pages.items():
    url = f'file:///C:/Users/User/Desktop/NEW/{html_file}'
    try:
        hti.screenshot(url=url, save_as=img_name, size=(1280, 800))
        print(f"Screenshot {img_name} taken.")
...
add_paragraph("Figure 2: Bean Boutique Home Page")
add_paragraph("Figure 3: Bean Boutique Coffee Selection Page")
add_paragraph("Figure 4: Bean Boutique Brewing Equipment Page")
add_paragraph("Figure 5: Bean Boutique Shopping Cart Page")
add_paragraph("Figure 6: Bean Boutique Events & Workshops Page")
add_paragraph("Figure 7: Bean Boutique Offers & Subscriptions Page")
doc.add_page_break()
...
add_heading('Website Screenshots', 2)

image_list = [
    ('index_ss.png', 'Figure 2: Bean Boutique Home Page'),
    ('coffee_selection_ss.png', 'Figure 3: Bean Boutique Coffee Selection Page'),
    ('brewing_equipment_ss.png', 'Figure 4: Bean Boutique Brewing Equipment Page'),
    ('shopping_cart_ss.png', 'Figure 5: Bean Boutique Shopping Cart Page'),
    ('events_workshops_ss.png', 'Figure 6: Bean Boutique Events & Workshops Page'),
    ('offers_subscriptions_ss.png', 'Figure 7: Bean Boutique Offers & Subscriptions Page')
]

for img_name, caption in image_list:
    full_img_path = os.path.join(r"c:\Users\User\Desktop\NEW\images", img_name)
...
doc.save(r'c:\Users\User\Desktop\NEW\Bean_Boutique_Final_Formatted_Report_v3.docx')
print("Document generated with all screenshots successfully.")
